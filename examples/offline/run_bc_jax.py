...
flags.DEFINE_float(
    "evaluation_epsilon", 0.0, "Epsilon for the epsilon greedy in the evaluation agent."
)
...
def main(_):
    ...
    dataset = bc_utils.make_demonstrations(environment.environment, FLAGS.batch_size)
    ...
    def evaluator_network(
        ...
        return rlax.epsilon_greedy(FLAGS.evaluation_epsilon).sample(key, dist_params)
