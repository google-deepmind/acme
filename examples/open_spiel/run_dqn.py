...
def main(_):
    ...
    environment = wrappers.SinglePrecisionWrapper(
        environment
    )  # type: open_spiel_wrapper.OpenSpielWrapper  # pytype: disable=annotation-type-mismatch
    ...
    loop = open_spiel_environment_loop.OpenSpielEnvironmentLoop(environment, agents)
