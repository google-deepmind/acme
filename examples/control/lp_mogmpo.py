...
"""Example running MoG-MPO on the control suite.
...
from acme.agents.tf import mog_mpo
import helpers
...
def main(_):
  ...
  program = mog_mpo.DistributedMoGMPO(
      environment_factory=environment_factory,
      network_factory=lp_utils.partial_kwargs(mog_mpo.make_default_networks),
      num_actors=2).build()
