...
class StructuredAdderTest(test_utils.AdderTestMixin, parameterized.TestCase):
  ...
  def test_sequence_adder(self,
    ...
    # We reuse the test cases from the SequenceAdder but the StructuredAdder
    # does not support adding padding steps as we assume that the padding will
    # be added on the learner side.
