...
"""Defines the WPO agent builder, which holds factories for all components."""
...
from acme.agents.jax.wpo import acting
from acme.agents.jax.wpo import config as wpo_config
from acme.agents.jax.wpo import learning
...
class WPOBuilder(builders.ActorLearnerBuilder):
  """Builder class for WPO agent components."""

  def __init__(self,
               config: wpo_config.WPOConfig,
               *,
  ...
  def make_learner(self,
    ...
    loss_scales_config = wpo_types.LossScalesConfig(
  ...
  def make_replay_tables(
    ...
    if isinstance(self.config.experience_type, wpo_types.FromTransitions):
      signature = adders.NStepTransitionAdder.signature(environment_spec,
                                                        extras_spec)
    elif isinstance(self.config.experience_type, wpo_types.FromSequences):
      sequence_length = (
