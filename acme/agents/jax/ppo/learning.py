...
from acme.agents.jax.ppo import networks, normalization
...
class PPOLearner(acme.Learner):
    ...
    def __init__(
        ...
        def epoch_update(
            carry: Tuple[TrainingState, Batch], unused_t: Tuple[()],
        ):
        ...
        def single_device_update(
            state: TrainingState, trajectories: types.NestedArray,
        ):
